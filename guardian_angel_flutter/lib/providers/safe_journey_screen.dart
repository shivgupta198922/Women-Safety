...
class _SafeJourneyScreenState extends State<SafeJourneyScreen> {
  ...
  void initState() {
    super.initState();
    _checkInInterval = Provider.of<SettingsProvider>(context, listen: false).defaultCheckInIntervalMinutes;
  }
  ...
  void _startJourney() async {
    if (_selectedWatchers.isEmpty) {
      AppUtils.showSnackBar(context, 'Please select at least one watcher.', isError: true);
      return;
    }
    ...
    try {
      ...
      AppUtils.showSnackBar(context, 'Safe Journey started!');
    } catch (e) {
      AppUtils.showSnackBar(context, journeyProvider.errorMessage ?? 'Failed to start journey.', isError: true);
    }
  }
  ...
  void _arrivedSafely() async {
    ...
    try {
      ...
      AppUtils.showSnackBar(context, 'Arrived safely! Journey ended.');
    } catch (e) {
      AppUtils.showSnackBar(context, journeyProvider.errorMessage ?? 'Failed to end journey.', isError: true);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final journeyProvider = Provider.watch<JourneyProvider>(context);
    ...
    return Column(
      ...
      children: [
        ...
        CustomButton(
          ...
          isLoading: Provider.of<JourneyProvider>(context).isLoading,
        ),
      ],
    );
  }
      ...
      children: [
        ...
        CustomButton(
          ...
          onPressed: () async {
            ...
            AppUtils.showSnackBar(context, 'Checked in successfully!');
          },
        ...
        CustomButton(
          ...
          onPressed: () {
            ...
            Provider.of<SosProvider>(context, listen: false).sendSos(type: 'JOURNEY_SOS');
            AppUtils.showSnackBar(context, 'SOS triggered from Safe Journey!');
          },
